...
export default function Profile() {
 ...
 async function getUserPosts(){
    ...
    let {data}=await axios.get(`${BaseUrl}/users/${userId }/posts?limit=2`,{
       headers:{
 ...
 let {data,isLoading}= useQuery({
  ...
  <div className="bg-white rounded-lg shadow-xl pb-8">
    ...
    <div className="flex flex-col items-center -mt-20">
      <img src={userData.photo} className="w-40 border-4 border-white rounded-full" />
      ...
      <p className="text-sm text-gray-500">Mansoura.eg</p>
    </div>
      ...
      <div className="flex-1 bg-white rounded-lg shadow-xl p-8">
        ...
        <ul className="mt-2 text-gray-700">
          ...
          <li className="flex border-b py-2">
            ...
            <span className="text-gray-700">{userData.createdAt.split('T')[0]}</span>
          </li>
